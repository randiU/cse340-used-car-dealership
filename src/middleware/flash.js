...
// Checks to see if session data has changed and needs to be saved before redirecting. Original res.redirect is saved because it will be overridden to check to see if session needs to be saved before redirecting. If session needs to be saved, it will call req.session.save() before redirecting. If not, it will redirect immediately.
    ...
    */
    ...
    //adds flash to req object and defines functionality for setting and getting flash messages
